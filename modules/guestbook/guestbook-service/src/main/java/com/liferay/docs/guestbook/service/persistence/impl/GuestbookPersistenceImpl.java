...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	protected Guestbook toUnwrappedModel(Guestbook guestbook) {
		...
		guestbookImpl.setEmail(guestbook.getEmail());
		guestbookImpl.setMessage(guestbook.getMessage());
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE = "SELECT DISTINCT {guestbook.*} FROM LB_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {LB_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM LB_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN LB_Guestbook ON TEMP_TABLE.guestbookId = LB_Guestbook.guestbookId";
	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE = "SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM LB_Guestbook guestbook WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "guestbook";
	private static final String _FILTER_ENTITY_TABLE = "LB_Guestbook";
	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";
	private static final String _ORDER_BY_ENTITY_TABLE = "LB_Guestbook.";
